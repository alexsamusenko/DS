"""Оптимизация дифференцированного внесения удобрений.

Кривая отклика на дозу (продолжение модели L4 законом Митчерлиха),
оптимизация по участкам без бюджета и с бюджетным ограничением (метод
Лагранжа), сравнение с равномерным внесением.
"""
