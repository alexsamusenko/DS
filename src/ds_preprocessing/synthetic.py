...
Используются вместо реальных открытых источников именно здесь, потому что
оценка ошибки восстановления требует известного эталона, недоступного в
реальных пропущенных данных.
"""
