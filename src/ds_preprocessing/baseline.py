...
пространственной структуры. Это обязательная точка сравнения наряду с
кригингом/трендом и комбинированным методом -- один из наиболее
распространённых на практике способов восстановления пропусков,
используемый здесь как реальная, а не декларативная точка сравнения.
"""
