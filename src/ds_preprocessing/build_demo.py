...
ожидаемое свойство комбинирования по обратной дисперсии (docs/chapter2/
preprocessing_model.md, §2.2.6): комбинированная оценка не хуже, а как
правило лучше, каждой из оценок по отдельности, и все три содержательных
метода не хуже наивной базовой линии.
...
def run_demo(n_trials=10):
    ...
    на каждой конкретной выборке (docs/chapter2/preprocessing_model.md,
    §2.2.6). Поэтому сравнение проводится по агрегированной ошибке на серии
